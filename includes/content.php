<header class="masthead">
    ...
    <div class="masthead-heading text-center mt-5">
        <h1>De Volkswagen UP! Het kleintje voor alles.</h1>
        <a class="btn btn-primary btn-lg js-scroll-trigger" href="motorisaties.php">Meer weten?</a>
    </div>
</header>
